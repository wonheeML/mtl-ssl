...
def build(anchor_generator_config):
  ...
  if anchor_generator_config.WhichOneof(
    ...
    return grid_anchor_generator.GridAnchorGenerator(
        ...
        use_hw_scales=grid_anchor_generator_config.use_hw_scales,
        height_scales=[float(scale) for scale
                       in grid_anchor_generator_config.height_scales],
        width_scales=[float(scale) for scale
                      in grid_anchor_generator_config.width_scales],
        align_lefttop=grid_anchor_generator_config.align_lefttop)
