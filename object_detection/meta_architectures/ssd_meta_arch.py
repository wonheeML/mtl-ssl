...
class SSDMetaArch(model.DetectionModel):
  ...
  def _assign_targets(self, groundtruth_boxes_list, groundtruth_classes_list
    ...
    Args:
      ...
      groundtruth_ignore_list: a list of 1-D tf.bool tensors of shape
        [num_boxes] containing whether or not to include in training loss calculation.
      groundtruth_crowd_list: a list of 1-D tf.bool tensors of shape
        [num_boxes] containing whether it is a single object or a crowd
